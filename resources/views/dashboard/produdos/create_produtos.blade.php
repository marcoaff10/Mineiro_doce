    ...
    <div class="row justify-content-center align-items-center p-3">
        <div class="col-lg-8 p-2">
            <form action="{{ route('store.produtos') }}" method="POST">
                @csrf
                <h3 class="text-center mb-3 fw-bold fs-4"><i class="bi bi-box me-2 align-middle"></i>Novo Produto </h3>
                ...
                <div class="mt-3 text-center ">
                    <a href="{{ route('estoque.produtos') }}" class="btn btnSecondary me-2">Cancelar</a>
