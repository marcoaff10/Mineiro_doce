                    ...
                    <div class="row justify-content-between mt-3">
                        <div class="col-sm-12 col-md-3 col-lg-3 my-2">
                            <a href="{{ route('destroy.vendas', $venda->id) }}"
                                class="btn btnSecondary w-100">Cancelar</a>
                        </div>

                        <div class="col-sm-12 col-md-3 col-lg-3 my-2">
                            <button type="submit" class="btn btnPrimary w-100" id="adicionar">Adicionar</button>
                        </div>

                        <div class="col-sm-12 col-md-4 col-lg-4 my-2">
                            @if (count($pedido) > 0)
                                <a href="{{ route('show.vendas') }}" class="btn btnSuccess w-100">Fechar Pedido</a>
                            @endif
                        </div>
                    </div>
